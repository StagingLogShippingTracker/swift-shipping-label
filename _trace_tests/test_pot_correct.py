"""Potrace with correct polarity (black letters on white)."""
...
def main() -> None:
    ...
    # Black letterforms on white background for potrace.
    letter = (np.array(ai) > 80).astype(np.uint8) * 255
    binary = Image.fromarray(255 - letter, mode="L")
    ...
    out = ROOT / "_trace_tests" / "pot_correct_polarity.svg"
